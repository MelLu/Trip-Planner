...
public class FinishedTripsListviewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finished_trips_listview);

        list = (ListView) findViewById(R.id.finishedListView);
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(FinishedTripsListviewActivity.this, TripDetailesActivity.class);
                i.setAction(FINISHED);
    ...
    protected void onStart() {
        super.onStart();
        tripDataList = db_adapter.getSelectionTripData(CreatNewTripActivity.FINISHED);
